...
void ParticleFilter::prediction(double delta_t, double std_pos[], double velocity, double yaw_rate)
{
  ...
  for (int i = 0; i < num_particles; i++)
  {
    ...
    // Adding predicted x,y and theta at time t+dt to x,y and theta at time t
    // Using bicycle model for prediction https://dingyan89.medium.com/simple-understanding-of-kinematic-bicycle-model-81cac6420357
...
void ParticleFilter::resample()
{
  ...
  // Particles are resampled using resampling wheel approach.
